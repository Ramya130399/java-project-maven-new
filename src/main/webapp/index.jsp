...
<body>
    ...
    <nav class="navbar">
        ...
        <ul class="nav-links">
            <li class="nav-items"><a href="#">vikranth</a></li>
            <li class="nav-items"><a href="#">Movies</a></li>
            <li class="nav-items"><a href="#">Sports</a></li>
            <li class="nav-items"><a href="#">Premium</a></li>
            <li class="nav-items"><a href="#">Ramya</a></li>
        ...
        <div class="card-container">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <h6 class="des">Morumm ipsum dolor sit consectetur elit.</h6>
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <h6 class="des">ramya ipsum dolor sit consectetur elit.</h6>
                    <button class="watchlist-btn">add to watchlist</button>
                </div>
            </div>
            <div class="card">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <h6 class="des">Pallavi shubham color sit consectetur elit.</h6>
                    <button class="watchlist-btn">add to watchlist</button>
                </div>
            </div>
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <h6 class="des">Lavanya ipsum dolor sit consectetur elit.</h6>
                    <button class="watchlist-btn">add to watchlist</button>
                </div>
            </div>
            <div class="card">
